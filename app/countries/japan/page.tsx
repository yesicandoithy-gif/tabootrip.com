      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="bg-green-50 rounded-xl p-8 border border-green-200">
          ...
          <ul className="space-y-4 text-lg">
            ...
            <li className="flex items-start"><span className="text-green-600 font-bold mr-3">•</span> Remove shoes before entering homes, ryokans, and temples</li>
            ...
            <li className="flex items-start"><span className="text-green-600 font-bold mr-3">•</span> Use both hands when giving/receiving items</li>
        ...
        <div className="bg-red-50 rounded-xl p-8 border border-red-200">
          ...
          <ul className="space-y-4 text-lg">
            ...
            <li className="flex items-start"><span className="text-red-600 font-bold mr-3">•</span> Don't stick chopsticks upright in rice</li>
            <li className="flex items-start"><span className="text-red-600 font-bold mr-3">•</span> Don't blow your nose in public</li>
            <li className="flex items-start"><span className="text-red-600 font-bold mr-3">•</span> Don't point with chopsticks</li>
          </ul>
        </div>
      </div>
